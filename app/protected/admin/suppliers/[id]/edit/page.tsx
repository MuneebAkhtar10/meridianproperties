...
import { deleteSupplierAction, updateSupplierAction } from "@/app/supplier-actions";
...
export default async function EditSupplierPage({ params, searchParams }: PageProps) {
  ...
  const [supplier, categories, properties, expenseCount] = await Promise.all([
  ...
  const coveredCategoryIds = new Set(
    supplier.categories.map((c) => c.categoryId),
  );
  const linkedPropertyIds = supplier.properties.map((p) => p.propertyId);
    ...
    <div className="w-full space-y-5 px-4 pt-4 pb-8 sm:px-6 lg:px-8">
      ...
      <form className="mx-auto max-w-4xl space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  name="companyNameAr"
                  dir="rtl"
                  defaultValue={supplier.companyNameAr ?? ""}
                />
              </div>
              <div className="grid grid-cols-[1fr_auto] items-end gap-3">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    defaultValue={supplier.externalReference ?? ""}
                  />
                </div>
                ...
                {categories.map((category) => (
                  <label key={category.id}>
                    <input
                      ...
                      name="categoryIds"
                      value={category.id}
                      defaultChecked={coveredCategoryIds.has(category.id)}
        ...
        <Card className="border-border/60 shadow-sm">
          ...
          <CardContent>
            <SupplierPropertyPicker
              properties={properties}
              defaultAllProperties={supplier.availableForAllProperties}
              defaultSelectedIds={linkedPropertyIds}
            />
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <label className="flex items-center gap-2 text-sm">
              <input
                ...
                defaultChecked={supplier.availableForEmergencies}
                className="h-4 w-4 rounded border-input"
              />
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  step="0.001"
                  defaultValue={
                    supplier.calloutCharge ? String(supplier.calloutCharge) : ""
                  }
                />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
                ...
                <Input
                  ...
                  defaultValue={
                    supplier.contractStart
                      ? dateInputValue(supplier.contractStart)
                      : ""
                  }
                />
              </div>
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  type="date"
                  defaultValue={
                    supplier.contractEnd ? dateInputValue(supplier.contractEnd) : ""
                  }
                />
              </div>
            </div>
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                name="contractInfo"
                className="min-h-20"
                defaultValue={supplier.contractInfo ?? ""}
              />
            </div>
          </CardContent>
        </Card>
        ...
        <div className="flex items-center justify-end gap-2 pb-2">
          <SubmitButton
            formAction={updateSupplierAction}
            pendingText="Saving..."
          >
      ...
      <Card className="mx-auto max-w-4xl border-destructive/30 bg-destructive/5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {expenseCount > 0
                  ? `Blocked — ${expenseCount} expense${expenseCount === 1 ? "" : "s"} still use this supplier.`
