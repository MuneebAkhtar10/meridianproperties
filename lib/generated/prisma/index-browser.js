...
exports.Prisma.PropertyTypeScalarFieldEnum = {
  ...
  isOwnerAssociation: 'isOwnerAssociation',
  isBuildingManagement: 'isBuildingManagement',
  showRentBills: 'showRentBills',
...
exports.Prisma.PropertyScalarFieldEnum = {
  ...
  chequePayableTo: 'chequePayableTo',
  poBox: 'poBox',
  approved: 'approved',
...
exports.Prisma.UnitScalarFieldEnum = {
  ...
  serviceChargeLastReminderAt: 'serviceChargeLastReminderAt',
...
exports.Prisma.UnitPermissionChangeScalarFieldEnum = {
  id: 'id',
  unitId: 'unitId',
  field: 'field',
  fromValue: 'fromValue',
...
exports.Prisma.OwnershipTransferScalarFieldEnum = {
  ...
  keptInstallmentPlan: 'keptInstallmentPlan',
  notes: 'notes',
...
exports.Prisma.AdminModuleGrantScalarFieldEnum = {
  id: 'id',
  userId: 'userId',
  module: 'module',
  createdAt: 'createdAt'
...
exports.Prisma.WorkerFamilyMemberScalarFieldEnum = {
  id: 'id',
  workerId: 'workerId',
  name: 'name',
...
exports.Prisma.ExpenseUnitScalarFieldEnum = {
  expenseId: 'expenseId',
  unitId: 'unitId'
};
...
exports.Prisma.UnitFundBalanceScalarFieldEnum = {
  unitId: 'unitId',
  fundId: 'fundId',
  balance: 'balance'
};

exports.Prisma.ServiceChargeInvoiceScalarFieldEnum = {
  id: 'id',
  unitId: 'unitId',
  fundId: 'fundId',
...
exports.Prisma.ServiceChargeInvoiceLineScalarFieldEnum = {
  id: 'id',
  invoiceId: 'invoiceId',
  fundId: 'fundId',
  description: 'description',
...
exports.Prisma.ServiceChargePaymentScalarFieldEnum = {
  id: 'id',
  unitId: 'unitId',
  fundId: 'fundId',
  amount: 'amount',
...
exports.Prisma.ServiceChargeInstallmentPlanScalarFieldEnum = {
  id: 'id',
  unitId: 'unitId',
...
exports.Prisma.ServiceChargeInstallmentScalarFieldEnum = {
  id: 'id',
  planId: 'planId',
  sequence: 'sequence',
  amount: 'amount',
...
exports.Prisma.BudgetIncomeLineScalarFieldEnum = {
  id: 'id',
  budgetId: 'budgetId',
  description: 'description',
  units: 'units',
...
exports.Prisma.BudgetExpenseLineScalarFieldEnum = {
  id: 'id',
  budgetId: 'budgetId',
  fundId: 'fundId',
  description: 'description',
...
exports.Prisma.ExpenseCategoryTypeScalarFieldEnum = {
  id: 'id',
  name: 'name',
  label: 'label',
  createdAt: 'createdAt',
...
exports.Prisma.SupplierScalarFieldEnum = {
  ...
  email: 'email',
  address: 'address',
  availableForEmergencies: 'availableForEmergencies',
  availableForAllProperties: 'availableForAllProperties',
...
exports.Prisma.BuildingServiceContractScalarFieldEnum = {
  id: 'id',
  propertyId: 'propertyId',
...
exports.Prisma.SupplierPropertyScalarFieldEnum = {
  supplierId: 'supplierId',
  propertyId: 'propertyId'
};

exports.Prisma.ExpenseSubcategoryTypeScalarFieldEnum = {
  id: 'id',
  categoryId: 'categoryId',
  label: 'label',
  createdAt: 'createdAt'
...
exports.Prisma.RejectionLogScalarFieldEnum = {
  id: 'id',
  kind: 'kind',
...
exports.Prisma.ServicesInvoiceScalarFieldEnum = {
  id: 'id',
  invoiceNumber: 'invoiceNumber',
  propertyId: 'propertyId',
  unitId: 'unitId',
...
exports.Prisma.ServicesInvoiceLineScalarFieldEnum = {
  id: 'id',
  invoiceId: 'invoiceId',
  sequence: 'sequence',
  qty: 'qty',
...
exports.WorkerCategory = exports.$Enums.WorkerCategory = {
  in_house: 'in_house',
  third_party: 'third_party'
};

exports.AdminModule = exports.$Enums.AdminModule = {
  dashboard: 'dashboard',
...
exports.PaymentCollector = exports.$Enums.PaymentCollector = {
...
exports.WhatsappFlow = exports.$Enums.WhatsappFlow = {
  new_request: 'new_request',
  worker_task: 'worker_task',
  awaiting_completion_code: 'awaiting_completion_code'
};

exports.RejectionKind = exports.$Enums.RejectionKind = {
  property: 'property',
  payment: 'payment',
...
exports.Prisma.ModelName = {
  ...
  Fund: 'Fund',
  UnitFundBalance: 'UnitFundBalance',
  ServiceChargeInvoice: 'ServiceChargeInvoice',
  ServiceChargeInvoiceLine: 'ServiceChargeInvoiceLine',
  ServiceChargePayment: 'ServiceChargePayment',
  ServiceChargeInstallmentPlan: 'ServiceChargeInstallmentPlan',
  ServiceChargeInstallment: 'ServiceChargeInstallment',
  AnnualBudget: 'AnnualBudget',
  BudgetIncomeLine: 'BudgetIncomeLine',
  BudgetExpenseLine: 'BudgetExpenseLine',
  ExpenseCategoryType: 'ExpenseCategoryType',
  Supplier: 'Supplier',
  BuildingServiceContract: 'BuildingServiceContract',
  SupplierCategory: 'SupplierCategory',
  SupplierProperty: 'SupplierProperty',
  ExpenseSubcategoryType: 'ExpenseSubcategoryType',
